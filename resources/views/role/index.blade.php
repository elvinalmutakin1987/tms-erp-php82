                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <a href="javascript:;" id="openModalButton" class="btn btn-primary mb-3 mb-lg-0"
                                        data-bs-toggle="modal" data-bs-target="#formModal" data-title="Add Role"><i
                                            class='bx bxs-plus-square'></i>New Role</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editButton', function() {
                ...
                $('#id').val(roleId);
                let url = '{{ route('role.show', ':_id') }}';
                url = url.replace(':_id', roleId);
                $.ajax({
                    url: url,
                    type: 'GET',
        ...
        function delete_(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = '{{ route('role.destroy', ':_id') }}';
