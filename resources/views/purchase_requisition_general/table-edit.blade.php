    ...
    <tr>
        ...
        <td class="p-1 align-middle">
            <input type="hidden" class="form-control" id="qty" name="qty[]" readonly
                value="{{ $d->qty ?? 0 }}">
            <input type="text" class="form-control" id="__qty" name="__qty[]" readonly style="text-align: right;"
        ...
        <td class="p-1 align-middle">
            ...
            <input type="text" class="form-control" id="__price" name="__price[]" readonly
                style="text-align: right;" value="{{ $d->price ? Number::format($d->price, precision: 0) : 0 }}">
        </td>
        <td class="p-1 align-middle">
        ...
        <td class="p-1 align-middle">
            ...
            <input type="text" class="form-control" id="__amount" name="__amount[]" readonly
                style="text-align: right;" value="{{ $d->amount ? Number::format($d->amount, precision: 0) : '' }}">
        </td>
            ...
            var newRow = `
                <tr>
                    ...
                    <td class="p-1 align-middle">
                       ...
                       <input type="text" class="form-control" id="__amount" name="__amount[]" readonly value="${_amount_}" style="text-align: right;">
                    </td>
                    <td class="text-center p-1 align-middle">
                        <div class="row row-cols-auto g-3">
                            <div class="col">
