...
<table style="width:100%;border-collapse:separate;border-spacing:0;">
    ...
    {{-- Header --}}
    <tr>
        <td style="{{ $headerStyle }}width:15px;"><b>No.</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Invoice</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Proforma Invoice</b></td>
        <td style="{{ $headerStyle }}width:250px;"><b>Keterangan</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Cut Off Date</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Konsolidasi Data<br>TMS &amp; CMD</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Kirim Progress<br>Klaim Approval</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Data Diterima<br>Dari Ops</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Proforma Invoice<br>Approved</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Minta CIC</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Pembuatan<br>CIC</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Terima CIC</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Tanggal Inv</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Pembuatan<br>Inv</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Kirim CIC<br>Ke KPC</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Informasi CIC<br>Bisa Diambil</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>CIC Diambil<br>TMS</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Invoice Terima<br>KPC</b></td>
        <td style="{{ $headerStyle }}width:100px;"><b>Status Bayar</b></td>
    </tr>
    ...
    @forelse ($invoiceGroups as $group)
        @php
            ...
            $paymentStyle =
                'text-align:center;vertical-align:middle;border:1px solid #000000;font-weight:bold;background-color:' .
                $paymentBg .
                ';color:' .
                $paymentColor .
                ';';
