    ...
    <tfoot>
        <tr>
            ...
            <td scope="col" class="p-1 align-middle">
                <input type="hidden" id="total" name="total" readonly value="0">
                <input type="text" class="form-control" id="total_" name="total_" readonly value="0"
                    style="text-align: right;">
            </td>
        ...
        <tr>
            ...
            <td scope="col" class="p-1 align-middle">
                <input type="hidden" id="discount" name="discount" readonly value="0">
                <input type="text" class="form-control" id="discount_" name="discount_" value="0"
                    style="text-align: right;">
            </td>
            <td scope="col" class="p-1 align-middle"></td>
        </tr>
        <tr>
            ...
            <td scope="col" class="p-1 align-middle">
                <input type="hidden" id="tax" name="tax" readonly value="0">
                <input type="text" class="form-control" id="tax_" name="tax_" readonly value="0"
                    style="text-align: right;">
            </td>
            <td scope="col" class="p-1 align-middle"></td>
        </tr>
        <tr>
            <td scope="col" colspan="5" class="text-end p-1 align-middle"><b>Grand
                    Total</b></td>
            <td scope="col" class="p-1 align-middle">
                <input type="hidden" id="grand_total" name="grand_total" readonly value="0">
...
<script>
    (() => {
        ...
        $('#addItemButton').on('click', function() {
            ...
            // var service_id = $("#service_").val();
            // var service = $("#service_ option:selected").text();
            var _qty = $("#_qty").val();
            var _qty_ = $("#_qty_").val();
