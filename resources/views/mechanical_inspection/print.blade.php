...
<table class="table-p2h">
    ...
    <thead>
            ...
            <th colspan="5" class="doc-header-wrapper">
                <table class="doc-header-table">
                    <tr>
                        ...
                        <td class="title-cell">
                            <div class="doc-title">MECHANICAL INSPECTION</div>
                            <div class="doc-subtitle">Vehicle Inspection</div>
                        </td>

                        <td class="meta-cell">
                            <div class="docno-label">Document No.</div>
                            <div class="docno">{{ $mechanical_inspection->inspection_no }}</div>
                        </td>
                    </tr>
                                    ...
                                    <td width="50%">
                                        <table class="info-inner">
                                            <tr>
                                                ...
                                                <td class="sep">:</td>
                                                <td class="val">{{ $mechanical_inspection->unit->vehicle_no ?? '-' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="label">Date</td>
                                                <td class="sep">:</td>
                                                <td class="val">{{ $mechanical_inspection->date ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="label">Inspector</td>
                                                <td class="sep">:</td>
                                                <td class="val">{{ $mechanical_inspection->inspector ?? '-' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
        ...
        <tr class="checklist-head">
            ...
            <th class="col-broken">Condition</th>
            <th class="col-defect">Remarks</th>
            <th class="col-action">Inspected By</th>
        </tr>
    </thead>
            ...
            @foreach ($items as $idx => $item)
                @php
                    ...
                    if ($inspection_detail) {
                        ...
                        $inspected_by = $inspection_detail->inspected_by;
                    }
                ...
                <tr class="{{ $rowClass }} avoid-break">
                    ...
                    <td class="col-defect cell-notes">{!! $remarks !!}</td>
                    <td class="col-action cell-notes">{!! $inspected_by !!}</td>
                </tr>
            @endforeach
        @endforeach
    </tbody>
