...
@section('content')
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <a href="javascript:;" id="openModalButton" class="btn btn-primary mb-3 mb-lg-0"
                                        data-bs-toggle="modal" data-bs-target="#formModal" data-title="Add Inspection"><i
                                            class='bx bxs-plus-square'></i>New Inspection</a>
                                </div>
                                <div class="col-2">
    ...
    @include('mechanical_inspection.modal')
@endsection
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '{{ route('mechanicalinspection.get_unit_all') }}',
                type: 'GET',
                success: function(response) {
                    $('#unit').empty();
        ...
        function delete_(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = '{{ route('mechanicalinspection.destroy', ':_id') }}';
        ...
        $('#formModal').on('show.bs.modal', function() {
            ...
            setTimeout(function() {
                ...
                const url = isEdit ?
                    '{{ route('mechanicalinspection.get_table_edit', ':_id') }}'.replace(':_id',
                        inspectionId) :
                    '{{ route('mechanicalinspection.get_table_add') }}';
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        const titleText = isEdit ? 'Edit Inspection' : 'Add Inspection';
                        const number = isEdit ? response.inspection_no : response
                            .inspection_prev_no;
