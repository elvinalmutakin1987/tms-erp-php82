    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editButton', function() {
                unitbrandId = $(this).data('id');
                $('#modal-header').text('Edit Unit Brand');
                $('#id').val(unitbrandId);
                let url = '{{ route('unitbrand.show', ':_id') }}';
                url = url.replace(':_id', unitbrandId);
                $.ajax({
                    url: url,
                    type: 'GET',
        ...
        function delete_(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    let url = '{{ route('unitbrand.destroy', ':_id') }}';
        ...
        $('#saveButton').on('click', function() {
            ...
            var title = "Saved!";
            if (unitbrandId != '') {
                url = '{{ route('unitbrand.update', ':_id') }}';
                url = url.replace(':_id', unitbrandId);
                title = "Updated!";
